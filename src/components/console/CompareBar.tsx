...
import { GitCompare, X, Trash2, AlertTriangle } from "lucide-react";
    ...
    <AlertDialog open={open} onOpenChange={setOpen}>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            This will remove all {selected.length} selected candidates from your comparison list. You can’t undo this action.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
